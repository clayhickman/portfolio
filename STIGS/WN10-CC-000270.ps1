<#
.SYNOPSIS
    This PowerShell script disables password saving in RDP.
...
if ($CurrentValue -eq $RegistryValue) {
    Write-Output "Password saving in Remote Desktop has been successfully disabled."
} else {
    Write-Output "Failed to configure DisablePasswordSaving. Please check manually."
}
